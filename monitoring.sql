...
--
-- Table structure for table `potencies`
--
...
--
-- Dumping data for table `potencies`
--
...
(17, 1, 'MUHAMMAD FARHAAN', 'farhaan.sales@sales.com', '$2y$10$5lHn2V7Hf4lCBAY0/5GSveFwK/2mA0zo/4UrFlTegKEJ1/H3vV2xq', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `sbu_names`
--
...
--
-- Dumping data for table `sbu_names`
--
...
--
-- AUTO_INCREMENT for table `potencies`
--
ALTER TABLE `potencies`
...
--
-- AUTO_INCREMENT for table `sbu_names`
--
ALTER TABLE `sbu_names`
...
--
-- Constraints for table `potencies`
--
ALTER TABLE `potencies`
